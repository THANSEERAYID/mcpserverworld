...
export default function Header() {
  ...
  return (
    <div className="bg-white">
      <div className="relative isolate px-6 pt-8 sm:pt-0 lg:pt-14 lg:px-8 ">
        <div
          aria-hidden="true"
        ...
        <div className="mx-auto max-w-2xl py-16 sm:py-32">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Announcing moonkeylab's next round of business.{' '}
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Explore a growing collection of MCP servers that bridge LLM with various external tools and data sources, enhancing their capabilities.
            </p>
